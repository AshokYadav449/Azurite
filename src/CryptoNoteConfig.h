...
//TODO Currency-specific address prefix "f9"
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x264;
...
const uint64_t MONEY_SUPPLY                                  = UINT_C(200000000);
...
const char     CRYPTONOTE_NAME[]                             = "Azurite";
...
const int      P2P_DEFAULT_PORT                              = 802;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 804;
